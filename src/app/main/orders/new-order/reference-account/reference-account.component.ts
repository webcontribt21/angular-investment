...
@Component({
  ...
  styleUrls: ['./reference-account.component.scss'],
})
export class ReferenceAccountComponent implements OnInit, OnDestroy {
  ...
  ngOnDestroy() {
    this.orderService.clearReferenceAccountForm();
  }
}
